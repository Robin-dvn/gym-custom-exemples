...
class GymWalk19(gym.Env):
    ...
    def step(self, action):
        ...
        if self.agent_location == 0 or self.agent_location == 20:
            terminated = True
        
        reward = 0
        if terminated:
            if self.agent_location == 20:
                reward = 1
            else:
                reward = 0
    ...
    def _render_frame(self):
        ...
        pygame.draw.rect(
            canvas,
            (255, 0, 255),
            pygame.Rect(20*pix_square_size,0,pix_square_size,pix_square_size),
        )
        pygame.draw.rect(
            canvas,
            (255, 0, 0),
